  ...
  return (
    ...
    <form className="flex flex-col items-center justify-center bg-white shadow-lg rounded-2xl p-8 w-96 mx-auto mt-20">
      ...
      <input
        ...
        className={`w-full rounded-lg border px-3 py-2 mb-4 text-center outline-none focus:ring-2 focus:ring-yellow-400 ${errorEmail ? "border-red-500 text-red-500" : "border-gray-300"
          }`}
      />
      ...
      <input
        ...
        className={`w-full rounded-lg border px-3 py-2 mb-6 text-center outline-none focus:ring-2 focus:ring-yellow-400 ${errorPassword ? "border-red-500 text-red-500" : "border-gray-300"
          }`}
      />
